	...
	<div class="container">
		...
		<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<button type="button" class="btn btn-success" id="enviar3"><span class="glyphicon glyphicon-search" 
			...
			$nik = mysqli_real_escape_string($con,(strip_tags($_GET["nik"],ENT_QUOTES)));
				 echo '<input type="hidden" id="idcat" name="idcat" value="'.$nik.'">';
			?>
			...
			$rela= mysqli_query($con, "SELECT DISTINCT id_ova FROM relacion WHERE id_cat='$nik'");
			
			if(mysqli_num_rows($rela) == 0){
				echo "<span class='glyphicon glyphicon-search' aria-hidden='true'></span> No se encontraron OVAS asociados a esta categoría</br></br>";
			}else{
