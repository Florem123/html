					...
					while($row = mysqli_fetch_assoc($sql)){                            
					  ...
					  <div class="card">
					    <div class="card-header" id="headingOne">
					      <h5 class="mb-0">
					        <img src="../img/areas.jpg" width="60" height="60"/><button class="btn btn-primary" data-toggle="collapse" data-target="#'.$row['id'].'" aria-expanded="true" aria-controls="collapseOne">
					          '.$row['descripcion'].'
					        </button>
					      </h5>
					    </div>
					    ...
					    <div id="'.$row['id'].'" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
					      <div class="card-body">';
					      		...
					      		if(mysqli_num_rows($sql2) == 0){
									echo '<button class="btn-danger" aria-expanded="true"><a class="btn-danger" href="recucat.php?nik='.$row['id'].'">Ver todas</button></a>';
								}else{
					
									while($row2 = mysqli_fetch_assoc($sql2)){
										echo '
										<button class="btn-danger" aria-expanded="true"><a class="btn-danger"  href="recusub.php?nik='.$row2['id'].'">'.$row2['descripcion'].'</button></a>
